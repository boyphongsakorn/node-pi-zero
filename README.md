...
## v16.20.2
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v16.20.2.sh | bash
```
...
## v18.17.1
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v18.17.1.sh | bash
```

## v18.18.0
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v18.18.0.sh | bash
```

## v18.18.1
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v18.18.1.sh | bash
```

## v18.18.2
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v18.18.2.sh | bash
```

## v18.19.0
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v18.19.0.sh | bash
```

## v18.19.1
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v18.19.1.sh | bash
```

## v18.20.2
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v18.20.2.sh | bash
```
...
## v20.5.1
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v20.5.1.sh | bash
```

## v20.6.0
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v20.6.0.sh | bash
```

## v20.6.1
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v20.6.1.sh | bash
```

## v20.7.0
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v20.7.0.sh | bash
```

## v20.8.0
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v20.8.0.sh | bash
```

## v20.8.1
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v20.8.1.sh | bash
```

## v20.9.0
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v20.9.0.sh | bash
```

## v20.10.0
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v20.10.0.sh | bash
```

## v20.11.0
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v20.11.0.sh | bash
```

## v20.11.1
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v20.11.1.sh | bash
```

## v20.12.0
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v20.12.0.sh | bash
```

## v20.12.1
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v20.12.1.sh | bash
```

## v20.12.2
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v20.12.2.sh | bash
```

## v21.0.0
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v21.0.0.sh | bash
```

## v21.1.0
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v21.1.0.sh | bash
```

## v21.2.0
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v21.2.0.sh | bash
```

## v21.3.0
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v21.3.0.sh | bash
```

## v21.4.0
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v21.4.0.sh | bash
```

## v21.5.0
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v21.5.0.sh | bash
```

## v21.6.0
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v21.6.0.sh | bash
```

## v21.6.1
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v21.6.1.sh | bash
```

## v21.6.2
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v21.6.2.sh | bash
```

## v21.7.3
```sh
$ wget -O - https://raw.githubusercontent.com/boyphongsakorn/node-pi-zero/master/install-node-v21.7.3.sh | bash
```
